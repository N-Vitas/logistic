...
<div class="box box-success">
  ...
  <div class="box-body list-group">
  	<div class="container-fluid">
	    ...
	    <div class="list-group-item row">
	    	<div class="col-md-6 col-lg-6 col-xs-6"><?=$model->getAttributeLabel('paymentStatus')?></div>
	    	<div class="col-md-6 col-lg-6 col-xs-6"><?= \yii\bootstrap\Html::tag('span', Order::$statusesPayments[$model->status_payments], ['class'=>'label label-'.Order::$statusClasses[$model->status_payments]]);?></div>            	
	    </div>
	    <div class="list-group-item row">
